...
#define DC_DAMAGE_DEFAULT_REACTION_BLOCK_LOWER	openborconstant("ANI_BLOCKPAIN3")
...
#define DC_DAMAGE_MEMBER_REACTION_BLOCK_LOWER	DC_DAMAGE_BASE_ID + 18
#define DC_DAMAGE_MEMBER_REACTION_BLOCK_MIDDLE	DC_DAMAGE_BASE_ID + 19
#define DC_DAMAGE_MEMBER_REACTION_BLOCK_UPPER	DC_DAMAGE_BASE_ID + 20
#define DC_DAMAGE_MEMBER_REACTION_PAIN_LOWER	DC_DAMAGE_BASE_ID + 21
#define DC_DAMAGE_MEMBER_REACTION_PAIN_MIDDLE	DC_DAMAGE_BASE_ID + 22
#define DC_DAMAGE_MEMBER_REACTION_PAIN_UPPER	DC_DAMAGE_BASE_ID + 23
#define DC_DAMAGE_MEMBER_TYPE					DC_DAMAGE_BASE_ID + 24
#define DC_DAMAGE_MEMBER_THE_END				25
