...
void main()
{
	...
	{
		dc_elmers_member_set_entity(taker);

		dc_elmers_member_set_offset_x(20);
		dc_elmers_member_set_offset_y(0);

		dc_elmers_member_set_position_adjust_quantity_x(5);
		dc_elmers_member_set_position_adjust_quantity_y(5);
